"""Sanity checks for SwinGeoLinkLandCoverGraphFusion."""

import torch
from mmseg.structures import SegDataSample

from mmgeo.models.swin_geolink_graph_fusion import SwinGeoLinkLandCoverGraphFusion
...
def main():
    ...
    module = SwinGeoLinkLandCoverGraphFusion(
    ...
    print('Swin GeoLink graph fusion shape sanity check passed')
